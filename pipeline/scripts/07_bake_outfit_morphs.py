...
CURATED_TARGETS = [
    ...
    # Must match 02_generate_body.py's own arm-target swap - see that
...
UPPER_TARGETS = [
    ...
    "weight_arm_upper_l_decr", "weight_arm_upper_l_incr",
    "weight_arm_upper_r_decr", "weight_arm_upper_r_incr",
    "weight_arm_lower_l_decr", "weight_arm_lower_l_incr",
    "weight_arm_lower_r_decr", "weight_arm_lower_r_incr",
    "weight_waist_decr", "weight_waist_incr",
    "belly_decr", "belly_incr", "belly_soft_decr", "belly_soft_incr",
