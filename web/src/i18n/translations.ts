...
export const translations: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    'cafe.menu.title': 'Меню',
    'cafe.menu.item1.name': 'Капучино',
    'cafe.menu.item1.desc': 'Эспрессо с молочной пенкой',
    'cafe.menu.item2.name': 'Травяной чай',
    'cafe.menu.item2.desc': 'Успокаивающий сбор трав',
    'cafe.menu.item3.name': 'Тост с авокадо',
    'cafe.menu.item3.desc': 'Цельнозерновой хлеб, авокадо, зелень',
    'cafe.menu.item4.name': 'Овощной суп',
    'cafe.menu.item4.desc': 'Тёплый суп дня',
    'cafe.menu.item5.name': 'Салат с киноа',
    'cafe.menu.item5.desc': 'Киноа, овощи, оливковое масло',
    'cafe.menu.item6.name': 'Фруктовый тарт',
    'cafe.menu.item6.desc': 'Песочное тесто, сезонные фрукты',
  },
  en: {
    ...
    'cafe.menu.title': 'Menu',
    'cafe.menu.item1.name': 'Cappuccino',
    'cafe.menu.item1.desc': 'Espresso with steamed milk foam',
    'cafe.menu.item2.name': 'Herbal tea',
    'cafe.menu.item2.desc': 'A calming herbal blend',
    'cafe.menu.item3.name': 'Avocado toast',
    'cafe.menu.item3.desc': 'Whole-grain bread, avocado, herbs',
    'cafe.menu.item4.name': 'Vegetable soup',
    'cafe.menu.item4.desc': 'Warm soup of the day',
    'cafe.menu.item5.name': 'Quinoa salad',
    'cafe.menu.item5.desc': 'Quinoa, vegetables, olive oil',
    'cafe.menu.item6.name': 'Fruit tart',
    'cafe.menu.item6.desc': 'Shortcrust pastry, seasonal fruit',
  },
};
