...
export const ED_MODEL_NODES: EDModelNode[] = [
  ...
  },
  {
    ...
    explanationRu:
      'Чтобы удержать ощущение контроля, человек устанавливает себе строгие, часто невыполнимые правила, например «никаких углеводов после шести» или «не больше 800 калорий в день». В реальной жизни такие правила почти неизбежно нарушаются, и любое отступление воспринимается не как мелочь, а как полный срыв. Именно это ощущение провала открывает путь к перееданию на следующем шаге.',
    explanationEn:
      'To hold on to a sense of control, a person builds strict, often unworkable rules, such as "no carbs after six" or "under 800 calories a day." Real life makes these almost impossible to keep, and the first slip reads not as minor but as total failure. That sense of failure is what pushes things toward a binge at the next step.',
  },
  {
    id: 'binge',
    titleRu: 'Переедания',
